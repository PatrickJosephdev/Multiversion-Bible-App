                        ...
                        itemBuilder: (context, index) {
                          ...
                          return GestureDetector(
                            onTap: (){
                              ...
                              Navigator.push(context, MaterialPageRoute(builder: (context) => ChapterPage(bookName: bookNames[index], version: selectedValue)));
                              // print(selectedValue);
                            ...
                            child: Container(
                              ...
                              child: Center(child: Text(
                                  bookNames[index],
                                style: TextStyle(
                                  fontSize: MediaQuery.of(context).size.width > 600 ? 30.0 : 15.0,
                                  color: Colors.white,
                                  overflow: TextOverflow.ellipsis ,
                                ),
                              )),
