    ...
    if (jsonData.containsKey('verses')) {
      ...
      if (booksData is List) {
        ...
        for (var VerseEntry in booksData) {
          ...
          if (VerseEntry is Map &&
              VerseEntry.containsKey('book_name') &&
              VerseEntry.containsKey('chapter')) {
            if (VerseEntry['book_name'] == widget.bookName) {
              ...
              if (VerseEntry['book_name'] == widget.bookName &&
                  VerseEntry['chapter'] == selectedChapterIndex + 1) {
                      ...
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        ...
                        return Chapter.isEmpty
                            ? const Row(
                                ...
                                children: [
                                  Text(
                                      'This Book is not Avialable for this Bible Version'),
                                ],
                              )
                            : ListView.builder(
                                  ...
                                  return GestureDetector(
                                    onTap: () {
                                      setState(() {
                                        ...
                                        Verses.clear();
                                        loadBibleData(
                                            versionValue, selectedChapterIndex);
